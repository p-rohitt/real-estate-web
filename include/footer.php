<footer class="full-row  p-0" style = "background-color:black">
            <div class="container">
                <div  class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logos/logo.png" alt="image"></a> </div>
                                        <p class = "text-white">
                                        Discover your dream property<br> with Bongora Tehsildar - your one-stop-shop<br> for all your real estate needs. Browse through our extensive collection of properties for sale, rent or lease and find the perfect fit for your budget and lifestyle.</p>
                                        </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>IT Park, Bongora Street, Guwahati</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>76652-23980</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 9865467039</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>helpline@bt.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2023 BT All rights reserved</span> </div>
                    <div class="col-sm-6">
