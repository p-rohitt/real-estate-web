    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Your Users</b></h2>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="full-row bg-gray">
            <div class="container">
                    <div class="row mb-5">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Users</h2>
							<?php
                                if(isset($_GET['msg'])) {
                                    echo $_GET['msg'];
                                }
...
while($row=mysqli_fetch_array($query)) {
    $row2 = " ";
    if ($row[5]) {
        $query2 = mysqli_query($con, "select agent_name from agent where agent_id = $row[5]");
