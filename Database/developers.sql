...
insert into `property`(`pid`,`title`,`pcontent`,`type`,`bhk`,`stype`,`bedroom`,`bathroom`,
`balcony`,`kitchen`,`hall`,`floor`,`size`,`price`,`location` ,
`city`,`state`,`feature`,`pimage`,`pimage1`,`pimage2`,`pimage3`,
`pimage4`,`uid`,`status`,`totalfloor`,`date`) values

(1,'DreamHome','<p> Best house in town </p>','Villa','3 BHK','sale',2,2,1,1,1,2,1000,3000000,'Adabari','Guwahati'
,'Assam','null','1.jpg','2.jpg','3.jpg','4.jpg','5.jpg',14,'available',2,'2020-04-03 00:28:14');
