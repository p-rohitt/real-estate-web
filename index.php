...
if (isset($_REQUEST['login'])) {
	...
	if (!empty($email) && !empty($pass)) {
		$sql = "SELECT * FROM user where user_email='$email' && user_pass='$pass'";
							...
							<div class="login-right">
								<div class="login-right-wrap">
									...
									<form method="post">
										...
										<button class="btn btn-dark text-white rounded-lg " name="login" value="Login"
											type="submit" style = "margin-left:115px;">Login</button>
